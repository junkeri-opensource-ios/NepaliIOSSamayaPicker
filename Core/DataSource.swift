...
open class DateDataSource {
    
    open var startingEnglishYear = 1944
    open var startingEnglishMonth = 01
    open var startingEnglishDay = 01
    
    open var startingNepaliYear = 2000
    open var startingNepaliMonth = 09
    open var startingNepaliDay = 17
    
    open func monthsInYearDict() -> SamayaIntDictionary {
    ...
    open func getStartingWeekDayOfMonth() -> SamayaIntDictionary {
        return [
    ...
    open let digits = ["०", "१", "२", "३", "४", "५", "६", "७","८", "९"]
    
    open func getMonths() -> [String] {
        return ["बैशाख", "जेष्ठ", "अषाढ", "श्रावण", "भाद्र", "असोज", "कात्तिक", "मंसिर", "पौष", "माघ", "फाल्गुन", "चैत्र"]
    }
    
    open func calculateDateDifference(fromDate: Date, toDate: Date) -> Int {
